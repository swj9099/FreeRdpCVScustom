...
#define ERRINFO_DISCONNECTED_BY_OTHER_CONNECTION_STRING \
		"[VM_Finished] Another user connected to the server, forcing the disconnection of the current connection."
...
#define ERRINFO_LOGOFF_BY_USER_STRING \
		"[VM_Finished] 连接因以下原因之一被中断：（1）用户名、密码错误 （2）连接的远程主机突然关机 The disconnection was initiated by the user logging off their session on the server."
